<template>
  <div class="container">
    <div class="input_modal">
       <el-button type="primary" size="medium" @click="handleAdd()">新增资讯</el-button>
    </div>
    <div class="input_modal">
    ...
    <div class="table_con">
      <el-table :data="tableData">
        ...
        <el-table-column :formatter="formatter" prop="title" label="资讯标题" />
  ...
  methods: {
    ...
    handleDeleteItem(id) {
      this.$confirm("确定删除?", "提示", {
        ...
        const { data } = await campaign.delete(id);
        if(data.status == 200) {
          this.$message({
            type: "success",
            message: "删除成功!"
