<template>
  <div class="container">
     <div class="input_modal">
        <el-button type="primary" size="medium" @click="handleAdd('service-edit')">新增商品</el-button>
        <el-button type="primary" size="medium" @click="handleAdd('service-goods-list')">分类管理</el-button>
    </div>
    <div class="input_modal">
      ...
      <el-table :data="tableData">
        ...
        <el-table-column prop="" label="操作" width="240px" >
          <template slot-scope="scope">
            ...
            <el-button type="primary" size="mini" @click="handleAdd('service-detail',scope.row.id)">查看</el-button>
            <el-button type="primary" size="mini" @click="handleAdd('service-edit',scope.row.id)">编辑</el-button>
